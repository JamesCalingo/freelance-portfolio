    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div5 = element("div");
    			h23 = element("h2");
    			h23.textContent = "Optimal performance";
    			t19 = space();
    			p3 = element("p");
    			...
    			attr_dev(h1, "class", "svelte-13u40og");
    			add_location(h1, file, 8, 4, 109);
    			attr_dev(header, "class", "svelte-13u40og");
    			...
    			attr_dev(a0, "class", "svelte-13u40og");
    			add_location(a0, file, 26, 16, 524);
    			attr_dev(button0, "class", "svelte-13u40og");
    			add_location(button0, file, 26, 8, 516);
    			attr_dev(div1, "class", "card svelte-13u40og");
    			add_location(div1, file, 24, 6, 452);
    			attr_dev(div2, "id", "paragraph");
    			attr_dev(div2, "class", "svelte-13u40og");
    			add_location(div2, file, 17, 4, 272);
    			add_location(h21, file, 32, 8, 641);
    			attr_dev(p1, "class", "description svelte-13u40og");
    			add_location(p1, file, 33, 8, 669);
    			attr_dev(div3, "class", "svelte-13u40og");
    			add_location(div3, file, 31, 6, 627);
    			add_location(h22, file, 40, 8, 879);
    			attr_dev(p2, "class", "description svelte-13u40og");
    			add_location(p2, file, 41, 8, 909);
    			attr_dev(div4, "class", "svelte-13u40og");
    			add_location(div4, file, 39, 6, 865);
    			add_location(h23, file, 48, 8, 1086);
    			attr_dev(p3, "class", "description svelte-13u40og");
    			add_location(p3, file, 49, 8, 1123);
    			attr_dev(div5, "class", "svelte-13u40og");
    			add_location(div5, file, 47, 6, 1072);
    			attr_dev(div6, "id", "bullets");
    			attr_dev(div6, "class", "svelte-13u40og");
    			add_location(div6, file, 30, 4, 602);
    			add_location(div7, file, 16, 2, 262);
    			attr_dev(div8, "id", "gallery");
    			attr_dev(div8, "class", "svelte-13u40og");
    			add_location(div8, file, 56, 2, 1278);
    			add_location(h24, file, 61, 4, 1405);
    			add_location(blockquote0, file, 64, 8, 1462);
    			attr_dev(li0, "class", "svelte-13u40og");
    			add_location(li0, file, 63, 6, 1449);
    			add_location(blockquote1, file, 69, 8, 1578);
    			attr_dev(li1, "class", "svelte-13u40og");
    			add_location(li1, file, 68, 6, 1565);
    			add_location(blockquote2, file, 79, 8, 1944);
    			attr_dev(li2, "class", "svelte-13u40og");
    			add_location(li2, file, 78, 6, 1931);
    			attr_dev(ul, "class", "svelte-13u40og");
    			add_location(ul, file, 62, 4, 1438);
    			attr_dev(div9, "id", "testemonial");
    			attr_dev(div9, "class", "card svelte-13u40og");
    			add_location(div9, file, 60, 2, 1365);
    			add_location(h25, file, 90, 4, 2194);
    			attr_dev(label0, "for", "name");
    			add_location(label0, file, 91, 4, 2227);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "svelte-13u40og");
    			add_location(input0, file, 92, 4, 2262);
    			attr_dev(label1, "for", "email");
    			add_location(label1, file, 94, 4, 2289);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "class", "svelte-13u40og");
    			add_location(input1, file, 95, 4, 2326);
    			attr_dev(label2, "for", "description");
    			add_location(label2, file, 97, 4, 2353);
    			attr_dev(textarea, "name", "description");
    			attr_dev(textarea, "id", "description");
    			attr_dev(textarea, "rows", "10");
    			attr_dev(textarea, "class", "svelte-13u40og");
    			add_location(textarea, file, 98, 4, 2409);
    			add_location(br, file, 99, 4, 2472);
    			attr_dev(button1, "type", "submit");
    			attr_dev(button1, "class", "svelte-13u40og");
    			add_location(button1, file, 100, 4, 2483);
    			add_location(p4, file, 102, 4, 2549);
    			attr_dev(a1, "href", "mailto:jciscreative@gmail.com");
    			attr_dev(a1, "class", "svelte-13u40og");
    			add_location(a1, file, 104, 6, 2621);
    			attr_dev(button2, "class", "svelte-13u40og");
    			add_location(button2, file, 103, 4, 2606);
    			attr_dev(div10, "id", "contact-form");
    			attr_dev(div10, "class", "svelte-13u40og");
    			add_location(div10, file, 89, 2, 2166);
    			attr_dev(main, "class", "svelte-13u40og");
    			add_location(main, file, 6, 0, 87);
    			attr_dev(a2, "href", "https://svelte.dev");
    			attr_dev(a2, "target", "blank");
    			add_location(a2, file, 109, 27, 2737);
    			add_location(p5, file, 108, 0, 2706);
    		},
