    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t49 = space();
    			p5 = element("p");
    			t50 = text("This site was made using ");
    			a2 = element("a");
    			a2.textContent = "Svelte";
    			attr_dev(h1, "class", "svelte-wijd98");
    			add_location(h1, file, 8, 4, 109);
    			attr_dev(header, "class", "svelte-wijd98");
    			...
    			attr_dev(a0, "class", "svelte-wijd98");
    			add_location(a0, file, 26, 16, 524);
    			attr_dev(button0, "class", "svelte-wijd98");
    			add_location(button0, file, 26, 8, 516);
    			attr_dev(div1, "class", "card svelte-wijd98");
    			add_location(div1, file, 24, 6, 452);
    			attr_dev(div2, "id", "paragraph");
    			attr_dev(div2, "class", "svelte-wijd98");
    			add_location(div2, file, 17, 4, 272);
    			add_location(h21, file, 32, 8, 641);
    			attr_dev(p1, "class", "description svelte-wijd98");
    			add_location(p1, file, 33, 8, 694);
    			attr_dev(div3, "class", "svelte-wijd98");
    			add_location(div3, file, 31, 6, 627);
    			add_location(h22, file, 40, 8, 904);
    			attr_dev(p2, "class", "description svelte-wijd98");
    			add_location(p2, file, 41, 8, 948);
    			attr_dev(div4, "class", "svelte-wijd98");
    			add_location(div4, file, 39, 6, 890);
    			add_location(h23, file, 48, 8, 1125);
    			attr_dev(p3, "class", "description svelte-wijd98");
    			add_location(p3, file, 49, 8, 1154);
    			attr_dev(div5, "class", "svelte-wijd98");
    			add_location(div5, file, 47, 6, 1111);
    			attr_dev(div6, "id", "bullets");
    			attr_dev(div6, "class", "svelte-wijd98");
    			add_location(div6, file, 30, 4, 602);
    			add_location(div7, file, 16, 2, 262);
    			attr_dev(div8, "id", "gallery");
    			attr_dev(div8, "class", "svelte-wijd98");
    			add_location(div8, file, 56, 2, 1309);
    			add_location(h24, file, 61, 4, 1436);
    			attr_dev(blockquote0, "class", "svelte-wijd98");
    			add_location(blockquote0, file, 64, 8, 1493);
    			attr_dev(li0, "class", "svelte-wijd98");
    			add_location(li0, file, 63, 6, 1480);
    			attr_dev(blockquote1, "class", "svelte-wijd98");
    			add_location(blockquote1, file, 67, 8, 1764);
    			attr_dev(li1, "class", "svelte-wijd98");
    			add_location(li1, file, 66, 6, 1751);
    			attr_dev(blockquote2, "class", "svelte-wijd98");
    			add_location(blockquote2, file, 75, 8, 2096);
    			attr_dev(li2, "class", "svelte-wijd98");
    			add_location(li2, file, 74, 6, 2083);
    			attr_dev(ul, "class", "svelte-wijd98");
    			add_location(ul, file, 62, 4, 1469);
    			attr_dev(div9, "id", "testemonial");
    			attr_dev(div9, "class", "card svelte-wijd98");
    			add_location(div9, file, 60, 2, 1396);
    			add_location(h25, file, 83, 4, 2412);
    			attr_dev(label0, "for", "name");
    			add_location(label0, file, 84, 4, 2445);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "svelte-wijd98");
    			add_location(input0, file, 85, 4, 2480);
    			attr_dev(label1, "for", "email");
    			add_location(label1, file, 87, 4, 2507);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "class", "svelte-wijd98");
    			add_location(input1, file, 88, 4, 2544);
    			attr_dev(label2, "for", "description");
    			add_location(label2, file, 90, 4, 2571);
    			attr_dev(textarea, "name", "description");
    			attr_dev(textarea, "id", "description");
    			attr_dev(textarea, "rows", "10");
    			attr_dev(textarea, "class", "svelte-wijd98");
    			add_location(textarea, file, 91, 4, 2627);
    			add_location(br, file, 92, 4, 2690);
    			attr_dev(button1, "type", "submit");
    			attr_dev(button1, "class", "svelte-wijd98");
    			add_location(button1, file, 93, 4, 2701);
    			add_location(p4, file, 95, 4, 2767);
    			attr_dev(a1, "href", "mailto:jciscreative@gmail.com");
    			attr_dev(a1, "class", "svelte-wijd98");
    			add_location(a1, file, 97, 6, 2839);
    			attr_dev(button2, "class", "svelte-wijd98");
    			add_location(button2, file, 96, 4, 2824);
    			attr_dev(div10, "id", "contact-form");
    			attr_dev(div10, "class", "svelte-wijd98");
    			add_location(div10, file, 82, 2, 2384);
    			attr_dev(main, "class", "svelte-wijd98");
    			add_location(main, file, 6, 0, 87);
    			attr_dev(a2, "href", "https://svelte.dev");
    			attr_dev(a2, "target", "blank");
    			add_location(a2, file, 102, 27, 2955);
    			add_location(p5, file, 101, 0, 2924);
    		},
