    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t51 = space();
    			p5 = element("p");
    			t52 = text("This site was made using ");
    			a2 = element("a");
    			...
    			if (img.src !== (img_src_value = "img/wdiw.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Where do I Worship");
    			add_location(img, file, 57, 3, 1331);
    			attr_dev(div8, "id", "gallery");
    			attr_dev(div8, "class", "svelte-9dwi61");
    			add_location(div8, file, 56, 2, 1309);
    			add_location(h24, file, 61, 4, 1433);
    			attr_dev(blockquote0, "class", "svelte-9dwi61");
    			add_location(blockquote0, file, 64, 8, 1490);
    			attr_dev(li0, "class", "svelte-9dwi61");
    			add_location(li0, file, 63, 6, 1477);
    			attr_dev(blockquote1, "class", "svelte-9dwi61");
    			add_location(blockquote1, file, 67, 8, 1761);
    			attr_dev(li1, "class", "svelte-9dwi61");
    			add_location(li1, file, 66, 6, 1748);
    			attr_dev(blockquote2, "class", "svelte-9dwi61");
    			add_location(blockquote2, file, 75, 8, 2093);
    			attr_dev(li2, "class", "svelte-9dwi61");
    			add_location(li2, file, 74, 6, 2080);
    			attr_dev(ul, "class", "svelte-9dwi61");
    			add_location(ul, file, 62, 4, 1466);
    			attr_dev(div9, "id", "testemonial");
    			attr_dev(div9, "class", "card svelte-9dwi61");
    			add_location(div9, file, 60, 2, 1393);
    			add_location(h25, file, 83, 4, 2409);
    			attr_dev(label0, "for", "name");
    			add_location(label0, file, 84, 4, 2442);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "svelte-9dwi61");
    			add_location(input0, file, 85, 4, 2477);
    			add_location(br0, file, 86, 0, 2499);
    			attr_dev(label1, "for", "email");
    			add_location(label1, file, 87, 4, 2508);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "class", "svelte-9dwi61");
    			add_location(input1, file, 88, 4, 2545);
    			add_location(br1, file, 89, 4, 2571);
    			attr_dev(label2, "for", "description");
    			add_location(label2, file, 90, 4, 2580);
    			add_location(br2, file, 91, 4, 2636);
    			attr_dev(textarea, "name", "description");
    			attr_dev(textarea, "id", "description");
    			attr_dev(textarea, "rows", "10");
    			attr_dev(textarea, "class", "svelte-9dwi61");
    			add_location(textarea, file, 92, 4, 2645);
    			add_location(br3, file, 93, 4, 2708);
    			attr_dev(button1, "type", "submit");
    			attr_dev(button1, "class", "svelte-9dwi61");
    			add_location(button1, file, 94, 4, 2719);
    			add_location(p4, file, 96, 4, 2785);
    			attr_dev(a1, "href", "mailto:jciscreative@gmail.com");
    			add_location(a1, file, 98, 6, 2857);
    			attr_dev(button2, "class", "svelte-9dwi61");
    			add_location(button2, file, 97, 4, 2842);
    			attr_dev(div10, "id", "contact-form");
    			attr_dev(div10, "class", "svelte-9dwi61");
    			add_location(div10, file, 82, 2, 2381);
    			attr_dev(main, "class", "svelte-9dwi61");
    			add_location(main, file, 6, 0, 87);
    			attr_dev(a2, "href", "https://svelte.dev");
    			attr_dev(a2, "target", "blank");
    			add_location(a2, file, 103, 27, 2973);
    			add_location(p5, file, 102, 0, 2942);
    		},
