    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			div1 = element("div");
    			div1.textContent = "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Culpa magni, vero debitis commodi corporis ad, praesentium consectetur voluptatum in veniam aperiam sunt nisi rem. Eos quam modi eaque omnis sed.";
    			t7 = space();
    			div6 = element("div");
    			div3 = element("div");
    			h21 = element("h2");
    			...
    			add_location(h4, file, 20, 6, 401);
    			add_location(div0, file, 19, 6, 389);
    			attr_dev(div1, "class", "card svelte-djnfdj");
    			add_location(div1, file, 22, 6, 588);
    			attr_dev(div2, "id", "paragraph");
    			attr_dev(div2, "class", "svelte-djnfdj");
    			add_location(div2, file, 18, 4, 362);
    			add_location(h21, file, 29, 6, 881);
    			attr_dev(p0, "class", "description svelte-djnfdj");
    			add_location(p0, file, 30, 6, 907);
    			attr_dev(div3, "class", "svelte-djnfdj");
    			add_location(div3, file, 28, 4, 869);
    			add_location(h22, file, 37, 6, 1105);
    			attr_dev(p1, "class", "description svelte-djnfdj");
    			add_location(p1, file, 38, 6, 1129);
    			attr_dev(div4, "class", "svelte-djnfdj");
    			add_location(div4, file, 36, 4, 1093);
    			add_location(h23, file, 47, 6, 1469);
    			attr_dev(p2, "class", "description svelte-djnfdj");
    			add_location(p2, file, 48, 6, 1491);
    			attr_dev(div5, "class", "svelte-djnfdj");
    			add_location(div5, file, 46, 4, 1457);
    			attr_dev(div6, "id", "bullets");
    			attr_dev(div6, "class", "svelte-djnfdj");
    			add_location(div6, file, 27, 2, 846);
    			...
    			add_location(div8, file, 60, 2, 1826);
    			add_location(h24, file, 65, 4, 1966);
    			add_location(br0, file, 68, 38, 2053);
    			attr_dev(li0, "class", "svelte-djnfdj");
    			add_location(li0, file, 67, 6, 2010);
    			add_location(br1, file, 75, 21, 2368);
    			attr_dev(li1, "class", "svelte-djnfdj");
    			add_location(li1, file, 71, 6, 2106);
    			add_location(br2, file, 80, 38, 2544);
    			attr_dev(li2, "class", "svelte-djnfdj");
    			add_location(li2, file, 78, 6, 2426);
    			attr_dev(ul, "class", "svelte-djnfdj");
    			add_location(ul, file, 66, 4, 1999);
    			attr_dev(div9, "id", "testemonial");
    			attr_dev(div9, "class", "card svelte-djnfdj");
    			add_location(div9, file, 64, 2, 1926);
    			add_location(h25, file, 87, 4, 2647);
    			attr_dev(label0, "for", "name");
    			add_location(label0, file, 88, 4, 2680);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "svelte-djnfdj");
    			add_location(input0, file, 89, 4, 2715);
    			attr_dev(label1, "for", "email");
    			add_location(label1, file, 91, 4, 2742);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "class", "svelte-djnfdj");
    			add_location(input1, file, 92, 4, 2779);
    			attr_dev(label2, "for", "description");
    			add_location(label2, file, 94, 4, 2806);
    			attr_dev(textarea, "name", "description");
    			attr_dev(textarea, "id", "description");
    			attr_dev(textarea, "rows", "10");
    			attr_dev(textarea, "class", "svelte-djnfdj");
    			add_location(textarea, file, 95, 4, 2862);
    			add_location(br3, file, 96, 4, 2925);
    			attr_dev(button0, "type", "submit");
    			add_location(button0, file, 97, 4, 2936);
    			add_location(p3, file, 99, 4, 3002);
    			attr_dev(a0, "href", "mailto:jciscreative@gmail.com");
    			attr_dev(a0, "class", "svelte-djnfdj");
    			add_location(a0, file, 101, 12, 3068);
    			attr_dev(button1, "class", "svelte-djnfdj");
    			add_location(button1, file, 101, 4, 3060);
    			attr_dev(div10, "id", "contact-form");
    			attr_dev(div10, "class", "svelte-djnfdj");
    			add_location(div10, file, 86, 2, 2619);
    			attr_dev(main, "class", "svelte-djnfdj");
    			add_location(main, file, 6, 0, 85);
    			attr_dev(a1, "href", "https://svelte.dev");
    			attr_dev(a1, "target", "blank");
    			add_location(a1, file, 105, 28, 3177);
    			add_location(p4, file, 105, 0, 3149);
    		},
